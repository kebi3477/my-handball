...
const ANNOUNCEMENTS: Announcement[] = [
  ...
  },
  {
    id: "notice-2",
    title: "마이핸드볼 점검 안내",
    body: "안녕하세요. 마이핸드볼 개발자입니다.\n개인사정으로 인해 서버의 위치가 변경되어 2026년 3월 7일 하루동안 서비스의 원활한 이용이 불가능할 예정입니다.\n\n빠른 시일 내로 서비스가 다시 정상화될 수 있도록 최선을 다하겠습니다.\n이용에 불편을 드려 죄송합니다.\n\n감사합니다.",
    createdAt: "2026-03-03",
  },
  {
    id: "notice-3",
    title: "플레이오프 일정 업데이트 안내",
    body: "마이핸드볼에 2025 시즌 플레이오프 일정이 반영되었습니다.\n메인 상단 경기 목록과 일정 페이지에서 플레이오프 경기를 확인하실 수 있습니다.\n\n일부 환경에서는 변경 사항 반영이 조금 늦을 수 있습니다.\n최신 내용이 보이지 않으면 앱을 다시 설치해주세요.\n감사합니다.",
